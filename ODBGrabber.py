    ...
    description = f"""{Fore.CYAN}
        ...
        \ \_/ /| |/ / | |_/ /| |_\ \| |   | (_| || |_) || |_) ||  __/| |   
         \___/ |___/  \____/  \____/|_|    \__,_||_.__/ |_.__/  \___||_|   
            ...
            {color.BOLD}ODBgrabber - Query open databases and grab only the data you care about!{Style.RESET_ALL}

    {Fore.LIGHTRED_EX}Examples:{Fore.RESET} python ODBgrabber.py -cn US -p 8080 -t users --elastic --shodan --csv --limit 100
